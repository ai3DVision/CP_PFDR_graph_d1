### TODO
# update according to octave/example_EEG_CP.m
# not sure that the TOY EXAMPLE is still relevent. In fact, it might illustrate
# a bit of syntax choices, but this deserves more comments and terminal output
# to precisely make the point.
