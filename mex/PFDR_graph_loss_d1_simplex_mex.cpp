/*=============================================================================
 * [P, it, Obj, Dif] = PFDR_graph_loss_d1_simplex_mex(Q, al, Eu, Ev, La_d1, 
 *     rho, condMin, difRcd, difTol, itMax, verbose)
 * 
 *  Hugo Raguet 2016
 *===========================================================================*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        PFDR_graph_loss_d1_simplex<double>(K, V, E, al, NULL, P, Q, Eu, Ev, \
            La_d1, rho, condMin, difRcd, difTol, itMax, it, Obj, Dif, verbose);
            /* 19 arguments */
    }else{
        ...
        PFDR_graph_loss_d1_simplex<float>(K, V, E, al, NULL, P, Q, Eu, Ev, \
            La_d1, rho, condMin, difRcd, difTol, itMax, it, Obj, Dif, verbose);
            /* 19 arguments */
    }
