/*=============================================================================
 * [Cv, rX, CP_it, Time, Obj, Dif] = CP_PFDR_graph_quadratic_d1_bounds_AtA_mex(
 *     AtY, AtA, Eu, Ev, La_d1, Bnd, CP_difTol, CP_itMax, PFDR_rho, 
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        CP_PFDR_graph_quadratic_d1_bounds<double>(V, E, -V, &rV, Cv, &rX, \
            AtY, AtA, Eu, Ev, La_d1, Bnd[0], Bnd[1], CP_difTol, CP_itMax, \
            CP_it, PFDR_rho, PFDR_condMin, PFDR_difRcd, PFDR_difTol, \
            PFDR_itMax, Time, Obj, Dif, verbose, NULL);
            /* 26 arguments */
        ...
        CP_PFDR_graph_quadratic_d1_bounds<float>(V, E, -V, &rV, Cv, &rX, AtY, \
            AtA, Eu, Ev, La_d1, Bnd[0], Bnd[1], CP_difTol, CP_itMax, CP_it, \
            PFDR_rho, PFDR_condMin, PFDR_difRcd, PFDR_difTol, PFDR_itMax, \
