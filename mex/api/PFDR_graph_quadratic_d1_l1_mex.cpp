/*=============================================================================
 * [X, it, Obj, Dif] = PFDR_graph_quadratic_d1_l1_mex(Y, A, Eu, Ev, La_d1,
 *      La_l1, positivity, L, rho, condMin, difRcd, difTol, itMax, verbose)
 *
 *  Hugo Raguet 2016
 *===========================================================================*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        PFDR_graph_quadratic_d1_l1<double>(V, E, N, X, Y, A, Eu, Ev, La_d1, \
            La_l1, pos, Ltype, L, rho, condMin, difRcd, difTol, itMax, it, \
            Obj, Dif, verbose);
           /* 22 arguments */
    }else{
