/*=============================================================================
 * [X, it, Obj, Dif] = PFDR_graph_l22_d1_l1_mex(Y, La_l2, Eu, Ev, La_d1, La_l1,
 *     positivity, rho, condMin, difRcd, difTol, itMax, verbose)
 * 
 *  Hugo Raguet 2016
 *===========================================================================*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        PFDR_graph_quadratic_d1_l1<double>(V, E, 0, X, Y, La_l2, Eu, Ev, \
            La_d1, La_l1, pos, DIAG, La_l2, rho, condMin, difRcd, difTol, \
        ...
        PFDR_graph_quadratic_d1_l1<float>(V, E, 0, X, Y, La_l2, Eu, Ev, \
            La_d1, La_l1, pos, DIAG, La_l2, rho, condMin, difRcd, difTol, \
            itMax, it, Obj, Dif, verbose);
            /* 22 arguments */
    ...
    V, E, N, Y[0], (void*) La_l2, X[0], Eu[0], Ev[0], La_d1[0], (void*) La_l1, \
    Ltype, L[0], rho, condMin, difRcd, difTol, itMax, *it, Obj != NULL, \
    Dif != NULL, verbose);
    mexEvalString("pause");
    */
}
