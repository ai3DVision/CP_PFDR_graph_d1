/*=============================================================================
 * [Cv, rX, CP_it, Time, Obj, Dif] = CP_PFDR_graph_quadratic_d1_l1_duplex_mex(Y,
 *     A, Eu, Ev, La_d1, La_l1, positivity, CP_difTol, CP_itMax, PFDR_rho, 
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        CP_PFDR_graph_quadratic_d1_l1_duplex<double>(V, E, N, &rV, Cv, &rX, Y, A, \
        ...
        CP_PFDR_graph_quadratic_d1_l1_duplex<float>(V, E, N, &rV, Cv, &rX, Y, A, \
            Eu, Ev, La_d1, La_l1, pos, CP_difTol, CP_itMax, CP_it, PFDR_rho, \
            PFDR_condMin, PFDR_difRcd, PFDR_difTol, PFDR_itMax, Time, Obj, \
            Dif, verbose, NULL);
            /* 26 arguments */
