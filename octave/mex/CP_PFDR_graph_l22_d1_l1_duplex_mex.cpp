/*=============================================================================
 * [Cv, rX, CP_it, Time, Obj, Dif] = CP_PFDR_graph_l22_d1_l1_duplex_mex(Y, La_l2, Eu,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        CP_PFDR_graph_quadratic_d1_l1_duplex<double>(V, E, 0, &rV, Cv, &rX, Y, \
            La_l2, Eu, Ev, La_d1, La_l1, pos, CP_difTol, CP_itMax, CP_it, \
        ...
        CP_PFDR_graph_quadratic_d1_l1_duplex<float>(V, E, 0, &rV, Cv, &rX, Y, La_l2, \
            Eu, Ev, La_d1, La_l1, pos,  CP_difTol, CP_itMax, CP_it, PFDR_rho, \
